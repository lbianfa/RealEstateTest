...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2f4217b3-959c-48d2-af82-f5538fb025be
```

> `2f4217b3-959c-48d2-af82-f5538fb025be` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the [RealEstateApi](./RealEstateApi) project directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disable it.
